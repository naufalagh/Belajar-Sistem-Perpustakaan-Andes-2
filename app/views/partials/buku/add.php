                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_kategori"  value="<?php  echo $this->set_field_value('id_kategori',""); ?>" type="text" placeholder="Enter Id Kategori"  required="" name="id_kategori"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tahun"  value="<?php  echo $this->set_field_value('tahun',""); ?>" type="text" placeholder="Enter Tahun"  required="" name="tahun"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
