                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-id_kategori"  value="<?php  echo $data['id_kategori']; ?>" type="text" placeholder="Enter Id Kategori"  required="" name="id_kategori"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tahun"  value="<?php  echo $data['tahun']; ?>" type="text" placeholder="Enter Tahun"  required="" name="tahun"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
